...
*@viewId:ui.s2p.mm.pur.ctr.maintain.sts1::sap.suite.ui.generic.template.ListReport.view.ListReport::C_ContractMaintain
*/
sap.ui.define([
	...
	function (
		...
		"use strict";
		return ControllerExtension.extend("customer.zcprstadapt11.customcontroller", {

			onPressCustomButton:function(){
				sap.m.MessageBox.show("Message Box");
			...
			// 	 * @memberOf customer.zcprstadapt11.customcontroller
			// 	 */
			// 	onInit: function() {
			// 	},
